...
(function() {
    ...
    // --------------------------------------------------------------------------------
    var G_embedCodeText, G_contentTitle, G_altText; function updateEmbedCodeText(embedCodeTextArea, startNew = 0) {
    ...
    function addEmbedCodePosterSelector(URLArray) {
        if (URLArray.length > 1) {
            ...
            function updateMainPoster(e) {
                ...
                updateEmbedCodeText(G_embedCodeTextArea, 1);
    ...
    var G_noQualitySample = false, G_qualitySampleSource = null, G_queryURL = null, G_standartAddEmbedCodeFunc = function() {
        ...
        G_embedCodeText = updateEmbedCodeText(G_embedCodeTextArea, 1);
        ...
        if (G_qualitySampleSource) {
            ...
            G_qualitySampleSource.addEventListener('play', function(e) {
                G_videoWidth = e.target.videoWidth;
                G_videoHeight = e.target.videoHeight;
        ...
        // --------------------------------------------------------------------------------
        if (G_queryURL) {
            GM_deleteValue('queryURL'); GM_setValue('queryURL', G_queryURL);
        ...
        if (
            ...
            G_funcToRun = function () {
                ...
                for (var index in thumbsArray) {
                    ...
                    updateEmbedCodeText(G_embedCodeTextArea, index==0 );
                }
