...
(function() {
    ...
    var sniper_crosshair_001 = "https://drive.google.com/file/d/1ipnPMUHY6bsbK1KtV4ytSl21a09c0VrS/view?usp=sharing";
    ...
    var png_sight_sniper = googl(sniper_crosshair_001); // Reticle_Scope_PU
    ...
    function initSettings() {
        ...
        //
        localStorage.kro_setngss_crosshairAlways = OFF;
        localStorage.kro_setngss_crosshairSho = 3;
        localStorage.kro_setngss_crosshairStyle = 1;
        /*
        localStorage.kro_setngss_crosshairAlways = ON;
        localStorage.kro_setngss_crosshairImage = png_crosshair;
        localStorage.kro_setngss_crosshairSho = 4;
        localStorage.kro_setngss_crosshairStyle = 1;
        */
        ...
        //
        localStorage.krk_hideFull = localStorage.krk_hideFull || "false"
        //
        localStorage.kro_setngss_dynamicHP = localStorage.kro_setngss_dynamicHP || OFF;
        localStorage.kro_setngss_scopeBorders = localStorage.kro_setngss_scopeBorders || OFF;
        localStorage.kro_setngss_showStreak = OFF;
    };
    initSettings();
    //
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function resetMarkSettings() {
            ...
            showCanvas = G_showCanvas || false; //true;
